...
/** 내 대시보드 에러 경계 — 세션/조회 실패 시 재시도 UI. */
export default function MyDashboardError({
  ...
  useEffect(() => {
    console.error('[dashboard/me] 렌더 오류:', error)
  }, [error])

  return (
    <section className="mx-auto flex max-w-2xl flex-col items-center gap-4 px-4 py-20 text-center sm:px-6">
      <h1 className="font-display text-ink text-2xl break-keep">{t('dashboard.me.error.title')}</h1>
